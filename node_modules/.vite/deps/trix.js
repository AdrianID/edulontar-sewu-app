...
var ri = class extends H {
  ...
  isBlockElement(t2) {
    if ((null == t2 ? void 0 : t2.nodeType) === Node.ELEMENT_NODE && !I(t2) && !A(t2, { matchingSelector: "td", untilNode: this.containerElement }))
      return L().includes(R(t2)) || "block" === window.getComputedStyle(t2).display;
  }
...
var Di = class {
  ...
  findContainerAndOffsetFromLocation(t2) {
    ...
    if (n2) {
      if (O(n2))
        0 === Ti(n2) ? (e2 = n2.parentNode.parentNode, i2 = C(n2.parentNode), P(n2, { name: "right" }) && i2++) : (e2 = n2, i2 = t2.offset - r2);
      else {
...
var Ni = class extends H {
  ...
  updateCurrentLocationRange(t2) {
    var e2, i2;
    if ((null != t2 ? t2 : t2 = this.createLocationRangeFromDOMRange(Nt())) && !Dt(t2, this.currentLocationRange))
...
var un = function(t2) {
  ...
  {
    let e2;
    if (null === t2.which ? e2 = t2.keyCode : 0 !== t2.which && 0 !== t2.charCode && (e2 = t2.charCode), null != e2 && "escape" !== on[e2])
