<div>
    <div class=" py-16 mt-16 flex items-center bg-[#004A27] justify-between gap-8 sm:mb-8 md:mb-12 p-4">
        <div class="flex items-center gap-12">
            <h2 class="text-2xl font-bold text-white lg:text-3xl">Wahana Lontar Sewu</h2>
        ...
        <a href="#"
            class="inline-block rounded-lg border border-transparent bg-white px-4 py-2 text-center text-sm font-semibold text-[#004A27] outline-none ring-indigo-300 transition duration-100 hover:bg-gray-100 focus-visible:ring active:bg-gray-200 md:px-8 md:py-3 md:text-base">
            More
        </a>
    </div>
